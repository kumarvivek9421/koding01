...
//		map() function Example:
        ...
        List<Integer> fruitList = fruit.stream().map(n->n.length()).collect(Collectors.toList());
...
//        using flatMap() Example:
     ...
     // making the arraylist object of List of Integer
        ...
        List<Integer> flatList = number.stream().flatMap(n->n.stream()).collect(Collectors.toList());
